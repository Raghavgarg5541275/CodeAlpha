...
heart_disease_model = pickle.load(open('D:/CodeAlpha/CodeAlpha_Disease_predictor/saved models/Heart.sav', 'rb'))
diabetes_model = pickle.load(open('D:/CodeAlpha/CodeAlpha_Disease_predictor/saved models/diabetes.sav', 'rb'))
parkinsons_model = pickle.load(open('D:/CodeAlpha/CodeAlpha_Disease_predictor/saved models/parkinsons.sav', 'rb'))

st.set_page_config(page_title="Disease Predictor", page_icon=":heartbeat:")
st.title("Disease Predictor")
st.write("Disease Predictor ")
